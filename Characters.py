...
class Characters:
    ...
    def buy_paczek(self):
        if (self.counter >= self.price_of_paczek):
            ...
            self.counter -= self.price_of_paczek
    ...
    def buy_katrin(self):
        if (self.counter >= self.price_of_katrin):
            ...
            self.counter -= self.price_of_katrin
    ...
    def buy_adalbert(self):
        if (self.counter >= self.price_of_adalbert):
            ...
            self.counter -= self.price_of_adalbert
            self.price_of_adalbert += 50000
    ...
    def get_char_info(self, mode, character):
        ...
        if(mode is "amount"):
            if(character is self.characters[0]):
                return self.amount_of_leon
            elif (character is self.characters[1]):
                return self.amount_of_riko
            elif (character is self.characters[2]):
                return self.amount_of_spider
            elif (character is self.characters[3]):
                return self.amount_of_paczek
            elif (character is self.characters[4]):
                return self.amount_of_katrin
            elif (character is self.characters[5]):
                return self.amount_of_adalbert
            else:
                return -1

        elif(mode is "price"):
            if(character is self.characters[0]):
                return self.price_of_leon
            elif (character is self.characters[1]):
                return self.price_of_riko
            elif (character is self.characters[2]):
                return self.price_of_spider
            elif (character is self.characters[3]):
                return self.price_of_paczek
            elif (character is self.characters[4]):
                return self.price_of_katrin
            elif (character is self.characters[5]):
